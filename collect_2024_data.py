...
def collect_2024_data():
    print("📥 Collecting all videos from 2024...")
    videos = fetch_videos_by_year(2024)
    combined_lines = []
    ...
    path = "bot_training_logs/2024_combined.txt"
    with open(path, "w", encoding="utf-8") as f:
        f.write("\n".join(combined_lines))

    print(f"✅ Saved combined data for 2024 → {path}")
