...
def collect_2023_data():
    print("📥 Collecting all videos from 2023...")
    videos = fetch_videos_by_year(2023)
    combined_lines = []
    ...
    path = "bot_training_logs/2023_combined.txt"
    with open(path, "w", encoding="utf-8") as f:
        f.write("\n".join(combined_lines))

    print(f"✅ Saved combined data for 2023 → {path}")
