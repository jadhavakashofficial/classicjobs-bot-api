...
def collect_2022_data():
    print("📥 Collecting all videos from 2022...")
    videos = fetch_videos_by_year(2022)
    combined_lines = []
    ...
    path = "bot_training_logs/2022_combined.txt"
    with open(path, "w", encoding="utf-8") as f:
        f.write("\n".join(combined_lines))

    print(f"✅ Saved combined data for 2022 → {path}")
