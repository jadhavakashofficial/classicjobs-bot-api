...
def collect_2025_data():
    print("📥 Collecting all videos from 2025...")
    videos = fetch_videos_by_year(2025)
    combined_lines = []
    ...
    path = "bot_training_logs/2025_combined.txt"
    with open(path, "w", encoding="utf-8") as f:
        f.write("\n".join(combined_lines))

    print(f"✅ Saved combined data for 2025 → {path}")
